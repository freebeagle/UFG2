...
class UFGraphFR(torch.nn.Module):
    def __init__(
        ...
        if self.use_item_attribute:
            ...
            self.item_alpha = torch.nn.Parameter(
                torch.tensor(self.item_attribute_alpha, dtype=torch.float32)
            )
    ...
    def get_item_embedding(self, items):
        ...
        if self.use_item_attribute:
            ...
            item_embedding = item_embedding + self.item_alpha * item_attribute_embedding
